...
// Realistic sample data matching the prompt
const OPPORTUNITIES = [
  {
    id: 'ai-sales-id', category: 'AI Sales Agents', market: 'Indonesia',
    momentum: 88, competitionDensity: 35, demand: 85, score: 92, confidence: 89,
    trend: '+24%', whyNow: 'SMB digitization wave colliding with LLM accessibility. Local incumbents lack modern AI features.',
    analogs: ['US', 'India']
  },
  {
    id: 'embed-fin-vn', category: 'Embedded Finance', market: 'Vietnam',
    momentum: 76, competitionDensity: 42, demand: 70, score: 84, confidence: 82,
    trend: '+18%', whyNow: 'Regulatory sandboxes opening up parallel to non-bank retail growth.',
    analogs: ['Brazil', 'US']
  },
  {
    id: 'creator-sg', category: 'Creator Tools', market: 'Singapore',
    momentum: 65, competitionDensity: 82, demand: 60, score: 68, confidence: 91,
    trend: '-4%', whyNow: 'High saturation from global incumbents. Only hyper-niche workflows viable.',
    analogs: ['US']
  },
  {
    id: 'health-ph', category: 'HealthTech', market: 'Philippines',
    momentum: 92, competitionDensity: 15, demand: 90, score: 96, confidence: 78,
    trend: '+31%', whyNow: 'Severe infra gaps being closed by new telehealth mandates and rising middle class.',
    analogs: ['India', 'Brazil']
  },
  {
    id: 'b2b-saas-th', category: 'B2B Logistics SaaS', market: 'Thailand',
    momentum: 74, competitionDensity: 65, demand: 80, score: 75, confidence: 85,
    trend: '+12%', whyNow: 'Supply chain fragmentation driving demand for unified visibility platforms.',
    analogs: ['US', 'India']
  },
  {
    id: 'sme-lending-my', category: 'SME Lending Infra', market: 'Malaysia',
    momentum: 55, competitionDensity: 48, demand: 65, score: 60, confidence: 80,
    trend: '+6%', whyNow: 'Open banking initiatives slowly gaining traction among traditional B2B lenders.',
    analogs: ['UK', 'Singapore']
  }
];
...
export default function DashboardTerminal() {
  ...
  const [selectedId, setSelectedId] = useState<string | null>('ai-sales-id'); // Default selection
          ...
          <div className="lg:col-span-7 bg-[#111113] border border-white/10 rounded-2xl p-8 relative overflow-hidden shadow-2xl flex flex-col justify-between group">
            ...
            <div>
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="text-right">
                  ...
                  <span className="text-4xl font-display font-bold text-white tracking-tighter shadow-brand-500/20 drop-shadow-lg">84</span>
                </div>
              </div>

              <div className="mb-6">
                <h3 className="text-3xl font-display font-semibold text-white mb-2 leading-tight">B2B Quick Commerce</h3>
                <div className="flex items-center gap-3 text-sm font-medium text-gray-400">
                  <span className="flex items-center gap-1.5"><svg className="w-4 h-4 text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg> Indonesia Tier-2 Cities</span>
                  <span>•</span>
                  <span className="text-brand-300">Confidence: 84%</span>
                  <span>•</span>
                  <span className="text-yellow-400">Competition: Low/Medium</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 mb-6">
                <div>
                  ...
                  <div className="text-lg font-mono font-medium text-green-400">+14%</div>
                </div>
                <div>
              ...
              <div className="bg-black/30 border border-white/5 rounded-xl p-4 mb-8">
                ...
                <p className="text-sm text-gray-300 leading-relaxed font-light">
                  "Strong analog signals from India and LATAM suggest an emerging window for procurement digitization in secondary Indonesian markets."
                </p>
              </div>
            </div>
            ...
            <div>
              <div className="flex gap-6 mb-6">
                <div className="flex items-center gap-2"><span className="text-white font-mono font-bold">12</span> <span className="text-xs text-gray-500 font-medium tracking-wide">Funding</span></div>
                <div className="flex items-center gap-2"><span className="text-white font-mono font-bold">18</span> <span className="text-xs text-gray-500 font-medium tracking-wide">Hiring</span></div>
                <div className="flex items-center gap-2"><span className="text-white font-mono font-bold">9</span> <span className="text-xs text-gray-500 font-medium tracking-wide">Launches</span></div>
                <div className="flex items-center gap-2"><span className="text-blue-400 font-mono font-bold">MODERATE</span> <span className="text-xs text-gray-500 font-medium tracking-wide">Regs</span></div>
              </div>
                  ...
                  {filteredData.map(op => {
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <span className="text-[10px] font-bold tracking-tight opacity-90 drop-shadow-md">
                            {op.score}
                          </span>
                        </div>
                        ...
                        <div className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-[#1a1a1c] border border-white/10 rounded-xl p-4 shadow-2xl transition-all pointer-events-none ${isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <div className={`text-xs font-black font-mono ${op.score >= 80 ? 'text-brand-400' : 'text-yellow-400'}`}>
                              {op.score}
                            </div>
                          </div>
                          <p className="text-[10px] text-gray-300 leading-relaxed mb-3 line-clamp-2">
                            {op.whyNow}
                          </p>
                 ...
                 <div className="flex-1 flex flex-col p-6 z-10 overflow-y-auto">
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <div className="text-right">
                        ...
                        <span className={`text-3xl font-display font-semibold tracking-tighter ${selectedOp.score >= 80 ? 'text-brand-400' : 'text-white'}`}>
                          {selectedOp.score}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mb-8">
                      ...
                      <p className="text-sm text-gray-300 leading-relaxed bg-[#161618] p-4 rounded-xl border border-white/5">
                        {selectedOp.whyNow}
                      </p>
                    </div>
                    
                    <div className="mt-auto space-y-3 pt-6">
                      <button className="w-full bg-brand-600 hover:bg-brand-500 text-white font-semibold py-3.5 rounded-xl transition-colors shadow-lg shadow-brand-500/20 text-sm">
                        View Full Analysis
                      </button>
                      <div className="grid grid-cols-2 gap-3">
                        <button className="bg-[#222] hover:bg-[#333] border border-white/5 text-xs font-medium text-white py-3 rounded-xl transition-colors">
                          Save Opportunity
                        </button>
                        <button className="bg-[#222] hover:bg-[#333] border border-white/5 text-xs font-medium text-white py-3 rounded-xl transition-colors">
                          Compare Markets
